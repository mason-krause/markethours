...
We created market ``markethours`` and `the markethours.info API <https://markethours.info/>`__
because we couldn't find other free tools for accessing stock trading hours, and we wanted to 
help others experiencing similar issues. 
...
See below for examples for using :class:`MarketHours <markethours.MarketHours>`:
...
.. autoclass:: markethours.MarketHours
  :members:
  :undoc-members:
